...
$(document).ready(function() {
    ...
    if (!buy_flow_cookie) {
        createCookie('buy_flow_locale',Drupal.settings.tesla.locale, 364);
    }
    ...
    // TWS-24048: JP/KR: remove the second month "月"/"월" and day "日"/"일" for one day event
    if ($('.date-display-single').length) {
        var dateDisplaySingle = $('.date-display-single');
        var teslaCountry = Drupal.settings.tesla.country;
        var stringTobeReplaced = '';
        if (teslaCountry == 'JP') {
            stringTobeReplaced = '月日';
        } else if (teslaCountry == 'KR') {
            stringTobeReplaced = '월일';
        }
        if(stringTobeReplaced.length) {
            dateDisplaySingle.html(dateDisplaySingle.html().replace(stringTobeReplaced, ''));
        }
    }
...
;
var geoip2=function(){"use strict";function a(t,e,n,r,s,o,a){this.successCallback=t,this.errorCallback=e,this.geolocation=(n&&n.hasOwnProperty("geolocation")?n:navigator).geolocation,this.endpoint=s&&""!=s?s:"",this.context=!o||"production"!=o&&"staging"!=o?"production":o,this.version=a&&""!=a&&-1!=a.indexOf("v")?a:"v1.0.3",this.type=r}function r(t){for(var e=window.location.search.substring(1).split("&"),n=0;n<e.length;n++){var r=e[n].split("=");if(r[0]===t)return r[1]}return!1}function s(t,e,n){var r=new RegExp("([?&])"+e+"=.*?(&|$)","i"),s=-1!==t.indexOf("?")?"&":"?";return t.match(r)?t.replace(r,"$1"+e+"="+n+"$2"):t+s+e+"="+n}var t={};return a.prototype.returnSuccess=function(t){this.successCallback&&"function"==typeof this.successCallback&&this.successCallback(t)},a.prototype.getGeoIPResult=function(){var e,n=this,t=(n.context,n.endpoint);void 0!==window.Drupal.settings.tesla.locationBaseUrl&&(t=window.Drupal.settings.tesla.locationBaseUrl+"/"+this.type,r("ip")&&(t=s(t,"ip",r("ip"))),(e=function(t,e){var n=new XMLHttpRequest,r=Math.random();try{n.open(t,s(e,"pc",r),!0)}catch(t){n=null}return n}("get",t))?(-1==navigator.userAgent.indexOf("Trident")?e.onreadystatechange=function(){if(4===e.readyState)if(e.status<200||400<=e.status)n.errorCallback();else try{var t=JSON.parse(e.responseText);n.returnSuccess(t)}catch(t){n.errorCallback()}}:e.readyState&&(e.onload=function(){if(e.status<200||400<=e.status)n.errorCallback(e.status);else try{var t=JSON.parse(e.responseText);n.returnSuccess(t)}catch(t){n.errorCallback()}}),e.send(e.responseText)):n.errorCallback())},t.country=function(t,e,n,r,s,o){new a(t,e,n,"country",r,s,o).getGeoIPResult()},t.city=function(t,e,n,r,s,o){new a(t,e,n,"city",r,s,o).getGeoIPResult()},t.connection=function(t,e,n,r,s,o){new a(t,e,n,"connection",r,s,o).getGeoIPResult()},t}();
;
var Tesla = Tesla || {};
...
// List of countries flagged as EU other (please see: tesla.locale.inc)
var euOtherCountries = ['BG', 'EE', 'GI', 'HU', 'LV', 'LI', 'LT', 'MC', 'PL', 'RO', 'RU', 'SM', 'SK', 'SI', 'TR'];
// WEB-12091 - supercharging map determine region by country code
// arrays used by regionByCountryCode function below
var euCountries = ['AD','CZ','AL','AT','BA','BE','BG','BY','CH','CY','CZ','DE','DK','EE','ES','FI','FO','FR','GB','GG','GI','GR','HR','HU','IE','IM','IS','IT','JE','LI','LT','LU','LV','MC','MD','MK','MT','NL','NO','PL','PT','RO','RU','SE','SI','SJ','SK','SM','TR','UA','UK','VA','YU','EU'];
var meCountries = ['EA', 'JO'];
var naCountries = ['US','CA','MX'];
var naOtherCountries = ['BR','IN','ZA'];
var apacCountries = ['AU','CN','HK','JP','MO','TW','KR','NZ', 'SG', 'IN'];
var kmCountries = new Array("de_AT", "de_CH", "de_DE", "en_AT", "en_AU", "en_BE", "en_CA", "en_CH", "en_DK", "en_EU", "en_HK", "en_IT", "en_NL", "es_ES", "es_MX", "fr_BE", "fr_CH", "fr_FR", "it_CH", "it_IT", "jp", "nl_NL", "no_NO", "fr_CA", "zh_HK", "en_MO", "zh_MO", "zh_TW", "ko_KR","en_IE", "en_NZ", "es_ES", "pt_PT", "is_IS", "cs_CZ", 'el_GR', 'pl_PL', 'en_SG', 'en_IN');
var validLocales = new Array("de_DE", "de_AT", "en_AU", "nl_BE", "fr_CA", "fr_CH", "it_CH", "de_CH", "da_DK", "en_HK", "es_MX", "fr_BE", "fr_FR", "it_IT", "jp", "nl_NL", "no_NO", "en_CA", "cn", "en_GB", "sv_SE", "fi_FI", "zh_HK", "en_MO", "zh_MO", "de_LU", "fr_LU", "zh_TW", "ko_KR","en_IE", "en_NZ", "es_ES", "pt_PT", "is_IS", "cs_CZ", 'el_GR', 'pl_PL', 'en_SG', 'en_IN');
...
Tesla.bround = function (num, decimalPlaces) {
...
* @param flags {object} ~ Determiners for how to filter and return the
*     formatted data type {boolean} ~ Return type. Default: string. Options:
*     array | object
*
**/
...
function localizeDate(m, day, year, flags) {
    ...
    case 'CZ':
        ...
        break;
    case 'GR':
        monthArray = {1: "Ιανουάριος", 2: "Φεβρουάριος", 3: "Μάρτιος", 4: "Απρίλιος", 5: "Μάιος", 6: "Ιούνιος", 7: "Ιούλιος", 8: "Αύγουστος", 9: "Σεπτέμβριος", 10: "Οκτώβριος", 11: "Νοέμβριος", 12: "Δεκέμβριος"};
        month = monthArray[m];
        curCarInfo.date = day + " " + month + " " + year;
        break;
    default:
 ...
 * Used when manipulating TC.userCountry for EU other countries where mismatch
 * may occur
 *
...
;
!function(t){var n={};function r(e){if(n[e])return n[e].exports;var o=n[e]={i:e,l:!1,exports:{}};return t[e].call(o.exports,o,o.exports,r),o.l=!0,o.exports}r.m=t,r.c=n,r.d=function(t,n,e){r.o(t,n)||Object.defineProperty(t,n,{configurable:!1,enumerable:!0,get:e})},r.r=function(t){Object.defineProperty(t,"__esModule",{value:!0})},r.n=function(t){var n=t&&t.__esModule?function(){return t.default}:function(){return t};return r.d(n,"a",n),n},r.o=function(t,n){return Object.prototype.hasOwnProperty.call(t,n)},r.p="",r(r.s=114)}([function(t,n){t.exports=function(t){return null!=t&&"object"==typeof t}},function(t,n){t.exports=function(t){var n=typeof t;return null!=t&&("object"==n||"function"==n)}},function(t,n){var r=Array.isArray;t.exports=r},function(t,n,r){var e=r(19),o=r(111),i=r(110),u="[object Null]",c="[object Undefined]",a=e?e.toStringTag:void 0;t.exports=function(t){return null==t?void 0===t?c:u:a&&a in Object(t)?o(t):i(t)}},function(t,n,r){var e=r(31),o="object"==typeof self&&self&&self.Object===Object&&self,i=e||o||Function("return this")();t.exports=i},function(t,n,r){var e=r(83);t.exports=function(t,n){var r=t.__data__;return e(n)?r["string"==typeof n?"string":"hash"]:r.map}},function(t,n){t.exports=function(t,n){return t===n||t!=t&&n!=n}},function(t,n,r){var e=r(6);t.exports=function(t,n){for(var r=t.length;r--;)if(e(t[r][0],n))return r;return-1}},function(t,n,r){var e=r(89),o=r(88),i=r(87),u=r(86),c=r(85);function a(t){var n=-1,r=null==t?0:t.length;for(this.clear();++n<r;){var e=t[n];this.set(e[0],e[1])}}a.prototype.clear=e,a.prototype.delete=o,a.prototype.get=i,a.prototype.has=u,a.prototype.set=c,t.exports=a},function(t,n,r){var e=r(3),o=r(1),i="[object AsyncFunction]",u="[object Function]",c="[object GeneratorFunction]",a="[object Proxy]";t.exports=function(t){if(!o(t))return!1;var n=e(t);return n==u||n==c||n==i||n==a}},function(t,n,r){var e=r(17)(Object,"create");t.exports=e},function(t,n,r){var e=r(9),o=r(14);t.exports=function(t){return null!=t&&o(t.length)&&!e(t)}},function(t,n){t.exports=function(t){return t.webpackPolyfill||(t.deprecate=function(){},t.paths=[],t.children||(t.children=[]),Object.defineProperty(t,"loaded",{enumerable:!0,get:function(){return t.l}}),Object.defineProperty(t,"id",{enumerable:!0,get:function(){return t.i}}),t.webpackPolyfill=1),t}},function(t,n,r){var e=r(27);t.exports=function(t,n,r){"__proto__"==n&&e?e(t,n,{configurable:!0,enumerable:!0,value:r,writable:!0}):t[n]=r}},function(t,n){var r=9007199254740991;t.exports=function(t){return"number"==typeof t&&t>-1&&t%1==0&&t<=r}},function(t,n){var r=9007199254740991,e=/^(?:0|[1-9]\d*)$/;t.exports=function(t,n){var o=typeof t;return!!(n=null==n?r:n)&&("number"==o||"symbol"!=o&&e.test(t))&&t>-1&&t%1==0&&t<n}},function(t,n,r){var e=r(76),o=r(0),i=Object.prototype,u=i.hasOwnProperty,c=i.propertyIsEnumerable,a=e(function(){return arguments}())?e:function(t){return o(t)&&u.call(t,"callee")&&!c.call(t,"callee")};t.exports=a},function(t,n,r){var e=r(98),o=r(94);t.exports=function(t,n){var r=o(t,n);return e(r)?r:void 0}},function(t,n,r){var e=r(3),o=r(0),i="[object Symbol]";t.exports=function(t){return"symbol"==typeof t||o(t)&&e(t)==i}},function(t,n,r){var e=r(4).Symbol;t.exports=e},function(t,n){t.exports=function(t){return t}},function(t,n,r){var e=r(45),o=r(43),i=r(11);t.exports=function(t){return i(t)?e(t,!0):o(t)}},function(t,n){t.exports=function(t,n){return"__proto__"==n?void 0:t[n]}},function(t,n,r){var e=r(51),o=r(50),i=r(49),u=i&&i.isTypedArray,c=u?o(u):e;t.exports=c},function(t,n,r){(function(t){var e=r(4),o=r(53),i="object"==typeof n&&n&&!n.nodeType&&n,u=i&&"object"==typeof t&&t&&!t.nodeType&&t,c=u&&u.exports===i?e.Buffer:void 0,a=(c?c.isBuffer:void 0)||o;t.exports=a}).call(this,r(12)(t))},function(t,n){var r=Object.prototype;t.exports=function(t){var n=t&&t.constructor;return t===("function"==typeof n&&n.prototype||r)}},function(t,n,r){var e=r(55)(Object.getPrototypeOf,Object);t.exports=e},function(t,n,r){var e=r(17),o=function(){try{var t=e(Object,"defineProperty");return t({},"",{}),t}catch(t){}}();t.exports=o},function(t,n,r){var e=r(13),o=r(6);t.exports=function(t,n,r){(void 0===r||o(t[n],r))&&(void 0!==r||n in t)||e(t,n,r)}},function(t,n,r){var e=r(17)(r(4),"Map");t.exports=e},function(t,n,r){var e=r(101),o=r(84),i=r(82),u=r(81),c=r(80);function a(t){var n=-1,r=null==t?0:t.length;for(this.clear();++n<r;){var e=t[n];this.set(e[0],e[1])}}a.prototype.clear=e,a.prototype.delete=o,a.prototype.get=i,a.prototype.has=u,a.prototype.set=c,t.exports=a},function(t,n,r){(function(n){var r="object"==typeof n&&n&&n.Object===Object&&n;t.exports=r}).call(this,r(32))},function(t,n){var r;r=function(){return this}();try{r=r||Function("return this")()||(0,eval)("this")}catch(t){"object"==typeof window&&(r=window)}t.exports=r},function(t,n,r){var e=r(6),o=r(11),i=r(15),u=r(1);t.exports=function(t,n,r){if(!u(r))return!1;var c=typeof n;return!!("number"==c?o(r)&&i(n,r.length):"string"==c&&n in r)&&e(r[n],t)}},function(t,n){var r=800,e=16,o=Date.now;t.exports=function(t){var n=0,i=0;return function(){var u=o(),c=e-(u-i);if(i=u,c>0){if(++n>=r)return arguments[0]}else n=0;return t.apply(void 0,arguments)}}},function(t,n){t.exports=function(t){return function(){return t}}},function(t,n,r){var e=r(35),o=r(27),i=r(20),u=o?function(t,n){return o(t,"toString",{configurable:!0,enumerable:!1,value:e(n),writable:!0})}:i;t.exports=u},function(t,n,r){var e=r(36),o=r(34)(e);t.exports=o},function(t,n){t.exports=function(t,n,r){switch(r.length){case 0:return t.call(n);case 1:return t.call(n,r[0]);case 2:return t.call(n,r[0],r[1]);case 3:return t.call(n,r[0],r[1],r[2])}return t.apply(n,r)}},function(t,n,r){var e=r(38),o=Math.max;t.exports=function(t,n,r){return n=o(void 0===n?t.length-1:n,0),function(){for(var i=arguments,u=-1,c=o(i.length-n,0),a=Array(c);++u<c;)a[u]=i[n+u];u=-1;for(var f=Array(n+1);++u<n;)f[u]=i[u];return f[n]=r(a),e(t,this,f)}}},function(t,n,r){var e=r(20),o=r(39),i=r(37);t.exports=function(t,n){return i(o(t,n,e),t+"")}},function(t,n,r){var e=r(40),o=r(33);t.exports=function(t){return e(function(n,r){var e=-1,i=r.length,u=i>1?r[i-1]:void 0,c=i>2?r[2]:void 0;for(u=t.length>3&&"function"==typeof u?(i--,u):void 0,c&&o(r[0],r[1],c)&&(u=i<3?void 0:u,i=1),n=Object(n);++e<i;){var a=r[e];a&&t(n,a,e,u)}return n})}},function(t,n){t.exports=function(t){var n=[];if(null!=t)for(var r in Object(t))n.push(r);return n}},function(t,n,r){var e=r(1),o=r(25),i=r(42),u=Object.prototype.hasOwnProperty;t.exports=function(t){if(!e(t))return i(t);var n=o(t),r=[];for(var c in t)("constructor"!=c||!n&&u.call(t,c))&&r.push(c);return r}},function(t,n){t.exports=function(t,n){for(var r=-1,e=Array(t);++r<t;)e[r]=n(r);return e}},function(t,n,r){var e=r(44),o=r(16),i=r(2),u=r(24),c=r(15),a=r(23),f=Object.prototype.hasOwnProperty;t.exports=function(t,n){var r=i(t),s=!r&&o(t),p=!r&&!s&&u(t),l=!r&&!s&&!p&&a(t),v=r||s||p||l,h=v?e(t.length,String):[],y=h.length;for(var x in t)!n&&!f.call(t,x)||v&&("length"==x||p&&("offset"==x||"parent"==x)||l&&("buffer"==x||"byteLength"==x||"byteOffset"==x)||c(x,y))||h.push(x);return h}},function(t,n,r){var e=r(13),o=r(6),i=Object.prototype.hasOwnProperty;t.exports=function(t,n,r){var u=t[n];i.call(t,n)&&o(u,r)&&(void 0!==r||n in t)||e(t,n,r)}},function(t,n,r){var e=r(46),o=r(13);t.exports=function(t,n,r,i){var u=!r;r||(r={});for(var c=-1,a=n.length;++c<a;){var f=n[c],s=i?i(r[f],t[f],f,r,t):void 0;void 0===s&&(s=t[f]),u?o(r,f,s):e(r,f,s)}return r}},function(t,n,r){var e=r(47),o=r(21);t.exports=function(t){return e(t,o(t))}},function(t,n,r){(function(t){var e=r(31),o="object"==typeof n&&n&&!n.nodeType&&n,i=o&&"object"==typeof t&&t&&!t.nodeType&&t,u=i&&i.exports===o&&e.process,c=function(){try{var t=i&&i.require&&i.require("util").types;return t||u&&u.binding&&u.binding("util")}catch(t){}}();t.exports=c}).call(this,r(12)(t))},function(t,n){t.exports=function(t){return function(n){return t(n)}}},function(t,n,r){var e=r(3),o=r(14),i=r(0),u={};u["[object Float32Array]"]=u["[object Float64Array]"]=u["[object Int8Array]"]=u["[object Int16Array]"]=u["[object Int32Array]"]=u["[object Uint8Array]"]=u["[object Uint8ClampedArray]"]=u["[object Uint16Array]"]=u["[object Uint32Array]"]=!0,u["[object Arguments]"]=u["[object Array]"]=u["[object ArrayBuffer]"]=u["[object Boolean]"]=u["[object DataView]"]=u["[object Date]"]=u["[object Error]"]=u["[object Function]"]=u["[object Map]"]=u["[object Number]"]=u["[object Object]"]=u["[object RegExp]"]=u["[object Set]"]=u["[object String]"]=u["[object WeakMap]"]=!1,t.exports=function(t){return i(t)&&o(t.length)&&!!u[e(t)]}},function(t,n,r){var e=r(3),o=r(26),i=r(0),u="[object Object]",c=Function.prototype,a=Object.prototype,f=c.toString,s=a.hasOwnProperty,p=f.call(Object);t.exports=function(t){if(!i(t)||e(t)!=u)return!1;var n=o(t);if(null===n)return!0;var r=s.call(n,"constructor")&&n.constructor;return"function"==typeof r&&r instanceof r&&f.call(r)==p}},function(t,n){t.exports=function(){return!1}},function(t,n,r){var e=r(11),o=r(0);t.exports=function(t){return o(t)&&e(t)}},function(t,n){t.exports=function(t,n){return function(r){return t(n(r))}}},function(t,n,r){var e=r(1),o=Object.create,i=function(){function t(){}return function(n){if(!e(n))return{};if(o)return o(n);t.prototype=n;var r=new t;return t.prototype=void 0,r}}();t.exports=i},function(t,n,r){var e=r(56),o=r(26),i=r(25);t.exports=function(t){return"function"!=typeof t.constructor||i(t)?{}:e(o(t))}},function(t,n){t.exports=function(t,n){var r=-1,e=t.length;for(n||(n=Array(e));++r<e;)n[r]=t[r];return n}},function(t,n,r){var e=r(4).Uint8Array;t.exports=e},function(t,n,r){var e=r(59);t.exports=function(t){var n=new t.constructor(t.byteLength);return new e(n).set(new e(t)),n}},function(t,n,r){var e=r(60);t.exports=function(t,n){var r=n?e(t.buffer):t.buffer;return new t.constructor(r,t.byteOffset,t.length)}},function(t,n,r){(function(t){var e=r(4),o="object"==typeof n&&n&&!n.nodeType&&n,i=o&&"object"==typeof t&&t&&!t.nodeType&&t,u=i&&i.exports===o?e.Buffer:void 0,c=u?u.allocUnsafe:void 0;t.exports=function(t,n){if(n)return t.slice();var r=t.length,e=c?c(r):new t.constructor(r);return t.copy(e),e}}).call(this,r(12)(t))},function(t,n,r){var e=r(28),o=r(62),i=r(61),u=r(58),c=r(57),a=r(16),f=r(2),s=r(54),p=r(24),l=r(9),v=r(1),h=r(52),y=r(23),x=r(22),b=r(48);t.exports=function(t,n,r,d,_,g,j){var m=x(t,r),O=x(n,r),w=j.get(O);if(w)e(t,r,w);else{var A=g?g(m,O,r+"",t,n,j):void 0,P=void 0===A;if(P){var S=f(O),z=!S&&p(O),T=!S&&!z&&y(O);A=O,S||z||T?f(m)?A=m:s(m)?A=u(m):z?(P=!1,A=o(O,!0)):T?(P=!1,A=i(O,!0)):A=[]:h(O)||a(O)?(A=m,a(m)?A=b(m):(!v(m)||d&&l(m))&&(A=c(O))):P=!1}P&&(j.set(O,A),_(A,O,d,g,j),j.delete(O)),e(t,r,A)}}},function(t,n){t.exports=function(t){return function(n,r,e){for(var o=-1,i=Object(n),u=e(n),c=u.length;c--;){var a=u[t?c:++o];if(!1===r(i[a],a,i))break}return n}}},function(t,n,r){var e=r(64)();t.exports=e},function(t,n,r){var e=r(8),o=r(29),i=r(30),u=200;t.exports=function(t,n){var r=this.__data__;if(r instanceof e){var c=r.__data__;if(!o||c.length<u-1)return c.push([t,n]),this.size=++r.size,this;r=this.__data__=new i(c)}return r.set(t,n),this.size=r.size,this}},function(t,n){t.exports=function(t){return this.__data__.has(t)}},function(t,n){t.exports=function(t){return this.__data__.get(t)}},function(t,n){t.exports=function(t){var n=this.__data__,r=n.delete(t);return this.size=n.size,r}},function(t,n,r){var e=r(8);t.exports=function(){this.__data__=new e,this.size=0}},function(t,n,r){var e=r(8),o=r(70),i=r(69),u=r(68),c=r(67),a=r(66);function f(t){var n=this.__data__=new e(t);this.size=n.size}f.prototype.clear=o,f.prototype.delete=i,f.prototype.get=u,f.prototype.has=c,f.prototype.set=a,t.exports=f},function(t,n,r){var e=r(71),o=r(28),i=r(65),u=r(63),c=r(1),a=r(21),f=r(22);t.exports=function t(n,r,s,p,l){n!==r&&i(r,function(i,a){if(c(i))l||(l=new e),u(n,r,a,s,t,p,l);else{var v=p?p(f(n,a),i,a+"",n,r,l):void 0;void 0===v&&(v=i),o(n,a,v)}},a)}},function(t,n,r){var e=r(72),o=r(41)(function(t,n,r){e(t,n,r)});t.exports=o},function(t,n,r){var e=r(3),o=r(0),i="[object Number]";t.exports=function(t){return"number"==typeof t||o(t)&&e(t)==i}},function(t,n,r){var e=r(18),o=1/0;t.exports=function(t){if("string"==typeof t||e(t))return t;var n=t+"";return"0"==n&&1/t==-o?"-0":n}},function(t,n,r){var e=r(3),o=r(0),i="[object Arguments]";t.exports=function(t){return o(t)&&e(t)==i}},function(t,n){t.exports=function(t,n){for(var r=-1,e=null==t?0:t.length,o=Array(e);++r<e;)o[r]=n(t[r],r,t);return o}},function(t,n,r){var e=r(19),o=r(77),i=r(2),u=r(18),c=1/0,a=e?e.prototype:void 0,f=a?a.toString:void 0;t.exports=function t(n){if("string"==typeof n)return n;if(i(n))return o(n,t)+"";if(u(n))return f?f.call(n):"";var r=n+"";return"0"==r&&1/n==-c?"-0":r}},function(t,n,r){var e=r(78);t.exports=function(t){return null==t?"":e(t)}},function(t,n,r){var e=r(5);t.exports=function(t,n){var r=e(this,t),o=r.size;return r.set(t,n),this.size+=r.size==o?0:1,this}},function(t,n,r){var e=r(5);t.exports=function(t){return e(this,t).has(t)}},function(t,n,r){var e=r(5);t.exports=function(t){return e(this,t).get(t)}},function(t,n){t.exports=function(t){var n=typeof t;return"string"==n||"number"==n||"symbol"==n||"boolean"==n?"__proto__"!==t:null===t}},function(t,n,r){var e=r(5);t.exports=function(t){var n=e(this,t).delete(t);return this.size-=n?1:0,n}},function(t,n,r){var e=r(7);t.exports=function(t,n){var r=this.__data__,o=e(r,t);return o<0?(++this.size,r.push([t,n])):r[o][1]=n,this}},function(t,n,r){var e=r(7);t.exports=function(t){return e(this.__data__,t)>-1}},function(t,n,r){var e=r(7);t.exports=function(t){var n=this.__data__,r=e(n,t);return r<0?void 0:n[r][1]}},function(t,n,r){var e=r(7),o=Array.prototype.splice;t.exports=function(t){var n=this.__data__,r=e(n,t);return!(r<0||(r==n.length-1?n.pop():o.call(n,r,1),--this.size,0))}},function(t,n){t.exports=function(){this.__data__=[],this.size=0}},function(t,n,r){var e=r(10),o="__lodash_hash_undefined__";t.exports=function(t,n){var r=this.__data__;return this.size+=this.has(t)?0:1,r[t]=e&&void 0===n?o:n,this}},function(t,n,r){var e=r(10),o=Object.prototype.hasOwnProperty;t.exports=function(t){var n=this.__data__;return e?void 0!==n[t]:o.call(n,t)}},function(t,n,r){var e=r(10),o="__lodash_hash_undefined__",i=Object.prototype.hasOwnProperty;t.exports=function(t){var n=this.__data__;if(e){var r=n[t];return r===o?void 0:r}return i.call(n,t)?n[t]:void 0}},function(t,n){t.exports=function(t){var n=this.has(t)&&delete this.__data__[t];return this.size-=n?1:0,n}},function(t,n){t.exports=function(t,n){return null==t?void 0:t[n]}},function(t,n){var r=Function.prototype.toString;t.exports=function(t){if(null!=t){try{return r.call(t)}catch(t){}try{return t+""}catch(t){}}return""}},function(t,n,r){var e=r(4)["__core-js_shared__"];t.exports=e},function(t,n,r){var e,o=r(96),i=(e=/[^.]+$/.exec(o&&o.keys&&o.keys.IE_PROTO||""))?"Symbol(src)_1."+e:"";t.exports=function(t){return!!i&&i in t}},function(t,n,r){var e=r(9),o=r(97),i=r(1),u=r(95),c=/^\[object .+?Constructor\]$/,a=Function.prototype,f=Object.prototype,s=a.toString,p=f.hasOwnProperty,l=RegExp("^"+s.call(p).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");t.exports=function(t){return!(!i(t)||o(t))&&(e(t)?l:c).test(u(t))}},function(t,n,r){var e=r(10);t.exports=function(){this.__data__=e?e(null):{},this.size=0}},function(t,n,r){var e=r(99),o=r(93),i=r(92),u=r(91),c=r(90);function a(t){var n=-1,r=null==t?0:t.length;for(this.clear();++n<r;){var e=t[n];this.set(e[0],e[1])}}a.prototype.clear=e,a.prototype.delete=o,a.prototype.get=i,a.prototype.has=u,a.prototype.set=c,t.exports=a},function(t,n,r){var e=r(100),o=r(8),i=r(29);t.exports=function(){this.size=0,this.__data__={hash:new e,map:new(i||o),string:new e}}},function(t,n,r){var e=r(30),o="Expected a function";function i(t,n){if("function"!=typeof t||null!=n&&"function"!=typeof n)throw new TypeError(o);var r=function(){var e=arguments,o=n?n.apply(this,e):e[0],i=r.cache;if(i.has(o))return i.get(o);var u=t.apply(this,e);return r.cache=i.set(o,u)||i,u};return r.cache=new(i.Cache||e),r}i.Cache=e,t.exports=i},function(t,n,r){var e=r(102),o=500;t.exports=function(t){var n=e(t,function(t){return r.size===o&&r.clear(),t}),r=n.cache;return n}},function(t,n,r){var e=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,o=/\\(\\)?/g,i=r(103)(function(t){var n=[];return 46===t.charCodeAt(0)&&n.push(""),t.replace(e,function(t,r,e,i){n.push(e?i.replace(o,"$1"):r||t)}),n});t.exports=i},function(t,n,r){var e=r(2),o=r(18),i=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,u=/^\w*$/;t.exports=function(t,n){if(e(t))return!1;var r=typeof t;return!("number"!=r&&"symbol"!=r&&"boolean"!=r&&null!=t&&!o(t))||u.test(t)||!i.test(t)||null!=n&&t in Object(n)}},function(t,n,r){var e=r(2),o=r(105),i=r(104),u=r(79);t.exports=function(t,n){return e(t)?t:o(t,n)?[t]:i(u(t))}},function(t,n,r){var e=r(106),o=r(16),i=r(2),u=r(15),c=r(14),a=r(75);t.exports=function(t,n,r){for(var f=-1,s=(n=e(n,t)).length,p=!1;++f<s;){var l=a(n[f]);if(!(p=null!=t&&r(t,l)))break;t=t[l]}return p||++f!=s?p:!!(s=null==t?0:t.length)&&c(s)&&u(l,s)&&(i(t)||o(t))}},function(t,n){var r=Object.prototype.hasOwnProperty;t.exports=function(t,n){return null!=t&&r.call(t,n)}},function(t,n,r){var e=r(108),o=r(107);t.exports=function(t,n){return null!=t&&o(t,n,e)}},function(t,n){var r=Object.prototype.toString;t.exports=function(t){return r.call(t)}},function(t,n,r){var e=r(19),o=Object.prototype,i=o.hasOwnProperty,u=o.toString,c=e?e.toStringTag:void 0;t.exports=function(t){var n=i.call(t,c),r=t[c];try{t[c]=void 0;var e=!0}catch(t){}var o=u.call(t);return e&&(n?t[c]=r:delete t[c]),o}},function(t,n,r){var e=r(3),o=r(2),i=r(0),u="[object String]";t.exports=function(t){return"string"==typeof t||!o(t)&&i(t)&&e(t)==u}},function(t,n,r){"use strict";(function(n){var e=r(112),o=r(109),i=r(74),u=r(73),c=r(9);t.exports=function(t){var n=t.localStorage,r=t.sessionStorage,a=n,f=!0,s=0,p={second:1e3,minute:6e4,hour:36e5,day:864e5,week:6048e5,month:2592e6};return a||(f=!1),{duration:p,set:function(t,n,r){if(!f)return null;r=r||{};var u,c,l={value:n,type:typeof n,timestamp:(new Date).getTime(),version:r.version||null};o(r,"expires")&&(l.expires=(u=r.expires,c=(new Date).getTime(),e(u)?o(p,u)&&(c+=p[u]):!isNaN(u)&&i(u)&&(c+=u),c)),s++;try{s<=2&&(a.setItem(t,JSON.stringify(l)),this.length=a.length),s=0}catch(e){this.purgeExpiredItems(),this.set(t,n,r)}},get:function(t,n){if(!f)return null;var r=a.getItem(t),e=(new Date).getTime(),o=null;try{r=JSON.parse(r)}catch(t){}if(r){if(c(n)&&!1===n(r))return null;if((r.expires||e)>=e)switch(r.type){case"object":case"string":o=r.value;break;case"number":o=parseFloat(r.value);break;default:o=r.value}}return o},merge:function(t,n,r){if(!f)return null;var e=a.getItem(t);if(e){e=JSON.parse(e),u(e.value,n);var o={expires:e.expires||Date.now(),type:e.type,timestamp:e.timestamp,version:e.version};this.set(t,e.value,u(o,r||{}))}else this.set(t,n,r)},remove:function(t){f&&(a.removeItem(t),this.length=a.length)},exists:function(t,n){return null!==this.get(t,n)},has:function(t,n){return this.exists(t,n)},keys:function(){for(var t=[],n=0,r=a.length;n<r;++n)t.push(a.key(n));return t},clear:function(){f&&a.clear()},purgeExpiredItems:function(){var t,n,r,e=(new Date).getTime();for(t=0;t<a.length;t++)n=a.key(t),(r=a.getItem(n)).timestamp+r.expires<e&&a.removeItem(n)},disable:function(){f=!1},setType:function(t){"session"===t&&r?a=r:"local"===t&&n&&(a=n)}}}("undefined"==typeof window?n:window)}).call(this,r(32))},function(t,n,r){var e=r(113);!function(t){t.Storage=e}(window)}]);;
...
(function (window, document, $, Drupal, Tesla) {
    ...
    $(document).ready(function() {
        // Check if there is an empty heading for a panel page
        let heading = $(".node-marketing-page > h2 > a").html();
        if (heading === "") {
          // Remove the empty heading since it has been left by panel bug  
          $(".node-marketing-page > h2").remove();
        }

        // Set GTM code for Contact Us link on Support pages
        if (window.location.pathname.indexOf("/support") > -1) {
            $("a[data-gtm-event]").click(function (event) {
                window.dataLayer.push({
                    'event': 'support',
...
(function (window, TeslaAnalytics, debug) {
  ...
  TeslaAnalytics.DNBBankCampaign = (function () {
    ...
    /**
     * Helpers for the Support page.
     * /support
     *
     * @see sites_d7/all/themes/custom/tesla_theme/js/support/support.js
     */
    TeslaAnalytics.SupportPage = (function () {
        var eventType = 'support';

        return {
            /**
             * @param clickedLabel string
             */
            learnMoreClick: function (clickedLabel) {
                TeslaAnalytics.Helpers.dataLayerPush({
                    event: eventType,
            ...
            /**
             * @param whichTab string
             */
            tabClick: function (whichTab) {
                TeslaAnalytics.Helpers.dataLayerPush({
                    event: eventType,
                    interaction: whichTab,
                    label: 'support-main',
                });
            },
        };
        ...
        attach: function (context) {
            ...
            function updateMeta(mediaQueryVar) {
                ...
                if(($('html').hasClass('touch') && mediaQueryVar.matches && !androidKeyboardActive) || BrowserDetect.OS === 'iOS Tablet Device' || $('html').hasClass('unresponsive')) {
                    ...
                    if(!$('#page-teslaaccount-settings-owner-add-car').length) {
